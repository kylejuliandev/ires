...
using Ires.Frontend.Client.Api.V1;
...
using System;
namespace Ires.Frontend.Client.Api
{
    /// <summary>
    ...
    public partial class ApiRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ires.Frontend.Client.Api.V1.V1RequestBuilder V1
        {
            get => new global::Ires.Frontend.Client.Api.V1.V1RequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ires.Frontend.Client.Api.ApiRequestBuilder"/> and sets the default values.
        /// </summary>
