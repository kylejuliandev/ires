...
using Ires.Frontend.Client.Api.V1.People;
...
using System;
namespace Ires.Frontend.Client.Api.V1
{
    /// <summary>
    ...
    public partial class V1RequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ires.Frontend.Client.Api.V1.People.PeopleRequestBuilder People
        {
            get => new global::Ires.Frontend.Client.Api.V1.People.PeopleRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ires.Frontend.Client.Api.V1.V1RequestBuilder"/> and sets the default values.
        /// </summary>
